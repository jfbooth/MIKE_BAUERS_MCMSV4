...
# slp_data_directory = '/localdrive/drive10/jj/mdtf/wkdir/MDTF_QBOi.EXP1.AMIP.001_1979_1979/etc_composites/tmp/data_converts'
# var_data_directory = '/localdrive/drive10/jj/mdtf/wkdir/MDTF_QBOi.EXP1.AMIP.001_1979_1979/etc_composites/tmp/data_converts'
# topo_file = '/localdrive/drive6/erai/converts/invariants.nc'
# model = 'qboi79'
...
thresh_landsea_hgt = 50.0 # in meters
thresh_landsea_lsm = 50.0/100.0 # in fractional amount of land
...
composite_var_list = ['pr', 'prw', 'uv10']
